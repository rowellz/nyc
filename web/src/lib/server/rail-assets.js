...
export function railAssetTransform(rel, source) {
  ...
  if (rel.endsWith('/main-D_3aygO4.js')) {
    ...
    source="import { functionalEntrance as $functionalEntrance, entranceYaw as $entranceYaw, entranceClosed as $entranceClosed } from './rail/access.js?v=station-layout-32';\n"+source;
