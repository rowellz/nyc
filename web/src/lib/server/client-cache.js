...
export const CLIENT_REVISION = 'world-distance-13';
const assets = /((?:\.\/|\/world\/assets\/|assets\/|\/world-addons\/)(?:[\w.-]+-[\w-]{8}\.js|mobile-build-policy\.js|mobile-road-material\.js|mobile-props\.js|predictive-streaming\.js|traffic-distribution\.js|mobile-map\.js))(?=["'`])/g;
