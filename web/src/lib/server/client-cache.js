...
export const CLIENT_REVISION = 'streaming-recovery-23';
const assets = /((?:\.\/|\/world\/assets\/|assets\/|\/world-addons\/)(?:[\w.-]+-[\w-]{8}\.js|mobile-build-policy\.js|mobile-road-material\.js|mobile-props\.js|predictive-streaming\.js|tile-requests\.js|startup-policy\.js|traffic-distribution\.js|signal-placement\.js|mobile-map\.js))(?=["'`])/g;
