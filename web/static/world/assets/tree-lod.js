...
export function treeBudget(quality, ios = false) {
  ...
  const far = quality.farDistance ?? 2000;
  return { distance: mobile ? Math.min(far * (ios ? .4 : .5), ios ? 4000 : 6000) : Math.min(far, 2000),
    middle: ios ? 150 : mobile ? 220 : 320, count: ios ? 4000 : mobile ? 8000 : 10000 };
}
