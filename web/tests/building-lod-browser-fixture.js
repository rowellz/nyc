...
window.testBuildingWorker=async()=>{
  ...
  try {
    const built=await new Promise((resolve,reject)=>{
      ...
      worker.postMessage({id:1,input:{key:'0_0',tx:0,tz:0,quality:'low',mobile:true,detailedIds:[],landmarkBins:[1],roads:[],
        buildings:[{id:1,height:100,floors:30,style:'glass',roofShape:'setback',footprint:[[[0,0],[40,0],[40,40],[0,40]]]}]}});
    });
    ...
    return{triangles,colored,colliders:built.colliders.length};
