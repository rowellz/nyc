import { ROAD_PROFILE_REACH as $roadProfileReach } from './ramps.js';
import { pedestrianTiles as $pedestrianTiles } from './pedestrian-clearance.js';
// NYC functional tunnels v1
// NYC approach streaming v1
// NYC ramp traffic heights v1
import { roadDeckHeight as $roadDeckHeight } from './supports.js';
import { syncTunnelTerrain as $tunnelTerrain, tunnelSupport as $tunnelSupport } from './tunnels.js';
...
return walkingHeight})();const $walkableAt=(()=>{const tiles=N,tileKey=p,TILE_SIZE=256,walkHeightIn=M;  function walkableAt(x        , z        )                 {
