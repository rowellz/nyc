/**
 * Named camera spots, lifted verbatim from the recovered client source
 * (src/client/src/core/spots.ts). Real coordinates.
 *
 * heading: compass degrees the camera looks toward. pitch: degrees, negative = down.
 * h: metres above the street datum.
 */
...
export const SPOTS: Spot[] = [
  ...
  // West sidewalk of 7th, just south of 44th: traffic corridor and screens, not the Broadway plaza.
  ...
  // West sidewalk near 41st; the library facade is on the left and 5th Avenue on the right.
  ...
  // Bleecker runs NNW here, not along the Midtown grid; the old point was a Grove Street rear lot.
...
/** Grouping for the gallery, by what each viewpoint is of. */
export const SPOT_GROUPS: { title: string; blurb: string; ids: string[] }[] = [
  {
    title: 'Landmarks',
    blurb: 'The buildings the city is known for, framed from the street.',
    ids: ['times-square', 'times-square-duffy', 'times-square-south', 'empire-state', 'flatiron', 'rockefeller', 'park-ave-viaduct', 'wall-street', 'columbus-circle'],
  },
  {
    title: 'Neighbourhoods',
    blurb: 'Street-level blocks with their own character.',
    ids: ['bryant-park', 'fifth-42nd', 'soho', 'west-village', 'east-village', 'chinatown', 'tribeca', 'lower-east-side', 'harlem', 'upper-west', 'union-square', 'central-park-south', 'park-ave-60'],
  },
  {
    title: 'Skyline and aerial',
    blurb: 'Wide views from the rivers and from altitude.',
    ids: ['skyline-hudson', 'skyline-east', 'brooklyn-bridge', 'hudson-yards', 'aerial-midtown', 'aerial-downtown', 'fdr'],
  },
];
